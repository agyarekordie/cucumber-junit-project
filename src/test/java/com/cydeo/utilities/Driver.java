...
public class Driver {
    ...
    private Driver(){}
    /*
    Making our 'driver' instance private, so that it is not reachable from outside on any class . We make it static, because we want it to run before anything else. Also we will it in static method
         */
